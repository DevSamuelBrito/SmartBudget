...
const TransactionTable = ({ transactions, onEdit, onDelete }: TransactionTableProps) => {
    ...
    const renderAutoGenerated = (isAutoGenerated: boolean) => {
        if (isAutoGenerated) {
            return <Check className="size-4 text-emerald-600" aria-label={t("actions.autoGeneratedAriaLabel")} />;
        }

        return <X className="size-4 text-rose-600" aria-label={t("actions.notAutoGeneratedAriaLabel")} />;
    };
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>{t("table.autoGenerated")}</TableHead>
                            <TableHead>{t("table.originTransaction")}</TableHead>
